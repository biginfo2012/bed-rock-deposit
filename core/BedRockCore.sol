...
contract BedRockCore is IBedRockCore, ERC20, BedRockPool, Ownable, ReentrancyGuard {
    ...
    function createSafe(
        ...
        safeConfigs[token] = safeConfig; // @audit-issue duplicate token?
